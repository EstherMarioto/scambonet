  ...
  <div class="row">
    ...
    <div class="row">
      ...
      $sth = $pdo->prepare('select *from tbl_doacao d 
              ...
              WHERE p.pro_usu_codigo = :usuario
              ');
          ...
          <div class="container">
            <ul class="collection">
              <li class="collection-item avatar ">
                ...
                <a href="trocaDo.php?doa_codigo=<?= $doa_codigo; ?>" input class="btn cyan lighten-3 " type="submit" span class=" black-text">Aceitar</span>
                  <a href="deleteDo.php?doa_codigo=<?= $doa_codigo; ?>" input class="btn cyan lighten-3 " type="submit" span class=" black-text">Recusar</span>
                  </a>
