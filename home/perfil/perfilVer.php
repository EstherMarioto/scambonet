...
<head>
  ...
  <style>
    .botao:hover {
      background-image: url('img/likee.png');
      ...
      <div class="col s12 m10 offset-m1" style="background-color: #e8eaf6">
        <table class="responsive-table ">
          ...
          <div class="row left">
            ...
            <div class="col s3">
              <form name="form2" method="post" action="insertavaliacao.php">
                <input name="pro_codigo" type="hidden" value="<?= $pro_codigo; ?>">
                <input name="usu_codigo" type="hidden" value="<?= $usu_codigo; ?>">
                <input type="image" src="img/likee.png" class="botao2" alt="Gostei">
                <input name="usu_avaliacao" type="hidden" value=1>
            ...
            <div class="col s1 ">
              ...
              $contadislike = $pdo->prepare("SELECT * FROM tbl_nota where not_ava_codigo = 1 and not_usu_codigo = :codigo ");
              $contadislike->bindValue(':codigo',  $usu_codigo);
              $contadislike->execute();
              //neste exemplo criei uma variável e nela atribuímos a quant. registros
              echo $contadislike->rowCount();
              ?>
            </div>
            ...
            <div class="col s2">
              <form name="form1" method="post" action="insertavaliacao.php">
                <input name="pro_codigo" type="hidden" value="<?= $pro_codigo; ?>">
                <input name="usu_codigo" type="hidden" value="<?= $usu_codigo; ?>">
                <input type="image" src="img/dislike.png" class="button" alt=" Não Gostei">
                <input name="usu_avaliacao" type="hidden" value=2>
            ...
            <div class="col s1 ">
              ...
              $contadislike = $pdo->prepare("SELECT * FROM tbl_nota where not_ava_codigo = 2 and not_usu_codigo = :codigo ");
              $contadislike->bindValue(':codigo',  $usu_codigo);
              $contadislike->execute();
              //neste exemplo criei uma variável e nela atribuímos a quant. registros
              echo $contadislike->rowCount();
      ...
      <div class="col s6 m2">
        <div class="card">
          <?php
            ...
            ?>
          <a href="exibirproduto/exibirproduto.php?pro_codigo=<?= $pro_codigo; ?>">
            <div class="card-image">
              <img src="../exibirproduto/img/o.gif">
            </div>
            <div class="card-content">
              <span class="card-title black-text">
                <h5><?= substr($pro_nome, 0, 10); ?></h5>
