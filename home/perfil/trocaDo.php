...
<div class="container">
    ...
    <form name="form1" method="post" action="inserttroca.php">
    <input name="doa_codigo" type="hidden" value="<?= $doa_codigo; ?>" ><br/>
    <input name="usu_codigo" type="hidden" value="<?= $_SESSION["scambo"]["id"]; ?>" ><br/>
    <br/>

    <?php

    $sth = $pdo->prepare('select *from tbl_doacao where doa_codigo = :doa_codigo');
   ...
   <div class="row">
    <div class="input-field col s8">
        <input name="locall" type="text" data-length="200">
        <label for="input_text"> Local ou endereço de envio </label>
    </div>
    </div>
    <div class="row">
    <div class="input-field col s8">
        <input name="celular" type="text" data-length="200">
