          ...
          <div class="container">
            <ul class="collection">
              <li class="collection-item avatar ">
                ...
                <a href="troca.php?ofe_codigo=<?= $ofe_codigo; ?>" input class="btn cyan lighten-3 " type="submit" span class=" black-text">Aceitar</span>
                  <a href="deletar.php?ofe_codigo=<?= $ofe_codigo; ?>" input class="btn cyan lighten-3 " type="submit" span class=" black-text">Recusar</span>
                  </a>
