...
<!-- nav bar -->
 ...
 <nav class="nav-extended" >
    ...
    <li><a href = "notificacao/notificacao.php"><span class= white-text >Notificações </span></a></li>
...
<br/>
<form name="form1" method="post" action="categoriat.php">
    <div class="row">
    ...
    $sth = $pdo->prepare('select * from tbl_produto  where pro_status = 1 ');
    $sth->execute();
    foreach ($sth as $res) :
        extract($res);
    ?>
