...
<?php
include 'conexao.php';
$end_cid_codigo = $_GET['end_cid_codigo'];
    ...
    <div class="container">
        <div class="row">
            <div class="card-panel" style="margin-top: 10%;">
                ...
                <form name="form" method="post" action="updatecadastrar.php" >
                    ...
                    <div class="input-field col s5">
                        <select name="uf">
                            <?php
                            $sth = $pdo->prepare(" SELECT * FROM tbl_uf where uf_codigo = :codigo");
                            $sth->bindValue(':codigo',  $end_cid_codigo);
                            $sth->execute();
                    ...
                    <div class="input-field col s5 ">
                        <select name="cidade">
                            <?php
                            $sth = $pdo->prepare(" SELECT * FROM tbl_cidade where cid_uf_codigo = :codigo");
                            $sth->bindValue(':codigo',  $end_cid_codigo);
                            $sth->execute();
